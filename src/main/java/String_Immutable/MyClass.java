...
public class MyClass {
    ...
    public static void main(String[] args) {
        ...
        // You will simply have another reference variable s2 (with same reference value as s1 probably?), this means it will point to the same object that contains "Cat" value
