...
public class pomClassPage1 extends BaseClass2 {
    ...
    // So basically, @BeforeAll will be executed only if is in the class with the test, meaning @Test
    // OR only if it is in the Parent class -> meaning the test class (@Test) needs to inherit it
